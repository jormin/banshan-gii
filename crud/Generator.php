...
class Generator extends \yii\gii\Generator
{
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['controllerClass', 'modelClass', 'modelName', 'searchModelClass', 'baseControllerClass'], 'filter', 'filter' => 'trim'],
            [['modelClass', 'modelName', 'controllerClass', 'baseControllerClass', 'indexWidgetType'], 'required'],
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'modelName' => 'This is the ActiveRecord name associated with the table that CRUD will be label upon.
                You should provide a fully qualified chinese name, e.g., <code>用户</code>.',
    ...
    public function generatePermissions(){
        ...
        $permission = Permission::findOne(['controller'=>$controller, 'action'=>'index']);
        if($permission){
            return;
        }
